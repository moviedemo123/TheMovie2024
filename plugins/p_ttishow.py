...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('📌 ᴄᴏɴᴛᴀᴄᴛ ꜱᴜᴘᴘᴏʀᴛ 📌', url=f'https://t.me/yoursupport12')
            ]]
            ...
            return
        buttons = [[
                    InlineKeyboardButton("🍁 ʜᴏᴡ ᴛᴏ ᴜꜱᴇ 🍁", url="https://t.me/newmoviedownload1?start=help")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
                  InlineKeyboardButton("📌 ᴄᴏɴᴛᴀᴄᴛ ꜱᴜᴘᴘᴏʀᴛ 📌", url="https://t.me/yoursupport12")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
